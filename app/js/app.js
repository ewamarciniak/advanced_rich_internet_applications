...
config(['$routeProvider', function ($routeProvider) {
    ...
    $routeProvider.when('/view2', { templateUrl: 'partials/partial2.php', controller: 'MyCtrl2' });
    ...
    $routeProvider.when('/view7', { templateUrl: 'partials/partial7.php', controller: 'MyCtrl7' });
    $routeProvider.when('/view8', { templateUrl: 'partials/partial8.php', controller: 'MyCtrl8' });
